...
def obtain_fresh_file_url_from_yandex_disk(public_link: str, path: str):
    ...
    if response:
        if response.status_code == HTTPStatus.OK:
            return response.json()["href"], response.elapsed.total_seconds()
        ...
        return path, download_error_message
